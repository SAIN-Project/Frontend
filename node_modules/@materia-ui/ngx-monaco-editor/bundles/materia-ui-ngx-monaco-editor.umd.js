(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('css-element-queries'), require('rxjs'), require('rxjs/operators'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@materia-ui/ngx-monaco-editor', ['@angular/core','exports', '@angular/core', 'css-element-queries', 'rxjs', 'rxjs/operators', '@angular/forms'], factory) :
    (global = global || self, factory(global.ng.core,(global['materia-ui'] = global['materia-ui'] || {}, global['materia-ui']['ngx-monaco-editor'] = {}), global.ng.core, global.cssElementQueries, global.rxjs, global.rxjs.operators, global.ng.forms));
}(this, (function (ɵngcc0,exports, core, cssElementQueries, rxjs, operators, forms) { 
var _c0 = ["editor"];
var _c1 = ["diffEditor"];
'use strict';

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('@angular/elements'), require('rete')) :
    typeof define === 'function' && define.amd ? define('rete-angular-render-plugin', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/common', '@angular/elements', 'rete'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global['rete-angular-render-plugin'] = {}, global.ng.core, global.ng.common, global.ng.elements, global.rete));
}(this, (function (ɵngcc0,ɵngcc1,exports, core, common, elements, rete) { 
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ReteModule, { declarations: [NodeComponent, SocketComponent, CustomComponent, ControlDirective, SocketDirective, KebabPipe], imports: [ɵngcc1.CommonModule], exports: [NodeComponent, CustomComponent, SocketComponent, ControlDirective, SocketDirective, KebabPipe] }); })();

...
export declare type SocketType = 'input' | 'output';
export declare type BindSocket = (el: HTMLElement, type: SocketType, io: IO) => void;
export declare type BindControl = (el: HTMLElement, control: Control) => void;
